  ...
  <div id="Tambahproker" class="w3-modal">
      <div class="w3-modal-content w3-animate-zoom w3-card-4">
          <div class="w3-card-4">
            ...
            <form class="w3-container" action="<?php $idOrganisasi = $this->session->userdata('akunAktif')->nama; echo base_url("C_Proker/tambahProker/$idOrganisasi") ?>" method="post" enctype="multipart/form-data" name="form1">
                <table class="w3-table w3-bordered-white">
                    ...
                    <tr>
                        <td style="width: 33%;"><h5></h5></td><td style="width: 2%;"><h5></h5></td><td style="width: 65%;" class="w3-right-align w3-small"><button class="w3-btn w3-green w3-card">Tambah</button></td>
                    </tr>
                    <tr><td></td></tr>
                </table>
            </form>
